...
function desc(expr) {
  ...
  return sql`${e} DESC NULLS LAST`.annotate({ label: e == null ? void 0 : e.label, desc: true });
}
...
function sqlFrom(data, {
  columns = Object.keys((data == null ? void 0 : data[0]) || {})
} = {}) {
  let keys = [];
...
//# sourceMappingURL=chunk-TVCBMZK3.js.map
